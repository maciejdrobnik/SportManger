                      ...
                      children: [
                        ...
                        Flexible(
                          ...
                          child: Padding(
                            ...
                            child: AutoSizeText(
                              timestampService.getDayandMonthFromTimeStamp(
                                      snapshot.data!.first.start) +
                                  " til " +
                                  timestampService.getDayandMonthFromTimeStamp(
                                      snapshot.data!.first.end),
                              maxLines: 1,
                        ...
                        Flexible(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              width: constants.widthNameContainer,
                              height: constants.heightNameContainer,
                              child: Column(
                                children: snapshot.data![0].assignees.map((e) {
                                  return Container(
                                      padding: EdgeInsets.only(
                                          top: constraints.maxHeight *
                                              constants
                                                  .choresAssgineesPaddingTop),
                                      child: Text(
                                        e,
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            fontSize: constants
                                                .choresAssigneesFontSize),
                                      ));
                                }).toList(),
                              ),
                            ),
